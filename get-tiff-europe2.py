...
from shared.util import append_layer, download_file, log
...
def set_circle_fn():
    """set_circle_fn: write to file and return arbitary 'European'
    circular GeoDataFrame determined by trial-and-error

    args:
      None

    returns:
      numpy geometry array
...
def get_european_boundary():
    ...
    _circle = set_circle_fn().to_crs(CRS)
